...
DEV_STAMP := $(EXTENSIONS_DIR)/micro_ros_dev/.dev.stamp
...
$(DEV_STAMP):
	...
	$(EXTENSIONS_DIR)/scripts/git_clone_retry.sh https://github.com/ament/ament_cmake jazzy src/ament_cmake; \
	$(EXTENSIONS_DIR)/scripts/git_clone_retry.sh https://github.com/ament/ament_lint jazzy src/ament_lint; \
	$(EXTENSIONS_DIR)/scripts/git_clone_retry.sh https://github.com/ament/ament_package jazzy src/ament_package; \
...
$(INSTALL_STAMP): $(EXTENSIONS_DIR)/esp32_toolchain.cmake $(DEV_STAMP) $(EXTENSIONS_DIR)/micro_ros_src/src | $(PRE_CLEAN)
	cd $(UROS_DIR); \
